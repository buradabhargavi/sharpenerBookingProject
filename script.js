function getList() {
  return axios.get(
    "https://crudcrud.com/api/b66f20c4e77645a39f3f8a29a34e13ba/bookings"
  );
}
...
function edit(booking) {
  ...
  axios
    .put(
      `https://crudcrud.com/api/b66f20c4e77645a39f3f8a29a34e13ba/bookings/${booking}`,
      {
        name: newName,
        seatNo: newSeatNo,
      }
...
function deleteBooking(bookingId) {
  axios
    .delete(
      `https://crudcrud.com/api/b66f20c4e77645a39f3f8a29a34e13ba/bookings/${bookingId}`
    )
    .then(() => {
      return getList();
    })
